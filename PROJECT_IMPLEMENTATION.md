# Alpernab — Standalone Real GUI Implementation
...
Default URL: `http://127.0.0.1:9101`

## What is inside this project folder

- `app/` — FastAPI backend for this project.
- `static/` — elegant browser GUI.
- `plugins/AlperNab.json` — this project’s own feature/customization/input schema.
...
- `div_align_center` — <div align="center"> (text) required
